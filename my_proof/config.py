...
<<<<<<< HEAD
    ...
    GOOGLE_TOKEN: Optional[str] = Field(
        default=None,
        description="Google OAuth2 access token for Instagram verification and Drive access",
        min_length=0,
    )

    # Instagram specific settings
    INSTAGRAM_DATA_TYPE: str = Field(
        default="profile",
        description="Type of Instagram data being processed (profile, posts, activity)",
    )

    # Upload source setting
